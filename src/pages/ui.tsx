...
import CardBoxComponentEmpty from '../common/CardBox/Component/Empty'
import CardBoxComponentTitle from '../common/CardBox/Component/Title'
      ...
      <SectionMain>
        <CardBox className="md:w-7/12 lg:w-5/12 xl:w-4/12 shadow-2xl md:mx-auto">
          <div className="text-center py-24 lg:py-12 text-gray-500 dark:text-slate-400">
            <Button label="Toggle" color="contrast" onClick={() => dispatch(setDarkMode())} />
          </div>
        </CardBox>
      </SectionMain>
